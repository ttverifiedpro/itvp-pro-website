  ...
  return (
    ...
    >
      <summary
        ...
        className={
          "list-none grid grid-cols-[1fr_24px] gap-x-2 hover:bg-pepper0 active:bg-pepper10 outline-blueberry80 outline-2 py-4 cursor-pointer scroll-mt-20 [&::-webkit-details-marker]:hidden"
        }
      >
